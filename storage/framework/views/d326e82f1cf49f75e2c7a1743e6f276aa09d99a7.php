...
<div class="form-group <?php echo e($errors->has('phone') ? 'has-error' : ''); ?>">
    ...
    <div class="col-md-6">
        <input class="form-control phone" name="phone" type="number" id="phone" value="<?php echo e(old($manager->getProfileDetail->phone??' ')); ?>" required>
...
<div class="form-group <?php echo e($errors->has('nation_id_card') ? 'has-error' : ''); ?>">
    ...
    <div class="col-md-6">
        <input class="form-control" name="nation_id_card" type="number" id="nation_id_card" value="<?php echo e(old($manager->getProfileDetail->nation_id_card??' ')); ?>" required>
...
<?php /**PATH C:\wamp64\www\opatlive\opatlive\resources\views/manager/manager/form.blade.php ENDPATH**/ ?>