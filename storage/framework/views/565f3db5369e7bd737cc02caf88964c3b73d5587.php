...
<div class="Form_p2" >
    ...
    <div class="form-group <?php echo e($errors->has('extension_granted') ? 'has-error' : ''); ?>">
        ...
        <div class="col-md-6">
            ...
            <input class="" style="margin-top: 9px" name="extension_granted" type="checkbox" id="extension_granted"    <?php if(isset($consumer) && $consumer->getUserDetail->profile->extension_granted_check == 'on'): ?> checked <?php endif; ?> >
...
<div class="col-md-6">
 ...
 <?php echo $errors->first('educationl_level_id', '<p class="help-block">:message</p>'); ?>
    ...
    <div class="form-group <?php echo e($errors->has('bridge_card_eligible') ? 'has-error' : ''); ?>">
        ...
        <div class="col-md-6">
            <input class=""  style="margin-top: 9px" name="bridge_card_eligible_check" type="checkbox" id="bridge_card_eligible_check"  <?php if(isset($consumer) && $consumer->getUserDetail->profile->bridge_card_eligible_check == 'on'): ?> checked <?php endif; ?> >
            <textarea class="form-control" name="bridge_card_eligible" type="bridge_card_eligible" id="bridge_card_eligible" > <?php echo e($consumer->getUserDetail->profile->bridge_card_eligible??''); ?> </textarea>
    ...
    <div class="form-group <?php echo e($errors->has('gov_assistance_eligible') ? 'has-error' : ''); ?>">
        <label for="gov_assistance_eligible" class="col-md-4 control-label"><?php echo e('Government Assistance Eligible'); ?></label>
        <div class="col-md-6">
            <input class=""  style="margin-top: 9px" name="gov_assistance_eligible_check" type="checkbox" id="gov_assistance_eligible_check"    <?php if(isset($consumer) && $consumer->getUserDetail->profile->gov_assistance_eligible_check == 'on'): ?> checked <?php endif; ?> >
            <textarea class="form-control" name="gov_assistance_eligible" type="text" id="gov_assistance_eligible" > <?php echo e($consumer->getUserDetail->profile->gov_assistance_eligible??''); ?> </textarea>
            <?php echo $errors->first('Bridge Card Eligible', '<p class="help-block">:message</p>'); ?>
    ...
    <div class="form-group <?php echo e($errors->has('injury') ? 'has-error' : ''); ?>">
        ...
        <div class="col-md-6">
        <input class=""  style="margin-top: 9px" name="injury_check" type="checkbox" id="injury_check" <?php if(isset($consumer) && $consumer->getUserDetail->profile->injury_check == 'on'): ?> checked <?php endif; ?> >
            <textarea class="form-control" name="injury" type="text" id="injury" > <?php echo e($consumer->getUserDetail->profile->injury??''); ?> </textarea>
...
<div class="col-md-6">
 <input class="form-control nationalIdCard" name="nation_id_card" id="nation_id_card" value="<?php echo e($consumer->getUserDetail->profile->nation_id_card??''); ?>" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength = "11" type="text" >
...
<div class="col-md-6">
 <input class="form-control phone"  name="phone" type="number" id="phone" value="<?php echo e($consumer->getUserDetail->profile->phone??''); ?>" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="13" type = "tel">
...
<?php $__env->stopPush(); ?><?php /**PATH C:\wamp64\www\OPAT_LIVE_FOR_CMS\resources\views/consumer/consumer/form.blade.php ENDPATH**/ ?>