...
<div class="form-group <?php echo e($errors->has('actual_amount') ? 'has-error' : ''); ?>">
    <label for="actual_amount" class="col-md-4 control-label"><?php echo e('Expected Amount'); ?></label>
    <div class="col-md-6">
...
<?php /**PATH /home2/devcusto/public_html/laravel/opat/resources/views/rentPayment/rent-payment/form.blade.php ENDPATH**/ ?>