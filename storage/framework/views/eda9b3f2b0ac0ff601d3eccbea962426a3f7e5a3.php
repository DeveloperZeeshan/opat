...
<div class="form-group <?php echo e($errors->has('name') ? 'has-error' : ''); ?>">
    ...
    <div class="col-md-6">
        <input class="form-control" name="name" type="text" id="name" value="<?php echo e($facility->name??''); ?>" required>
...
<div class="form-group <?php echo e($errors->has('phone') ? 'has-error' : ''); ?>">
    ...
    <div class="col-md-6">
        <input class="form-control" name="phone"  id="phone" value="<?php echo e($facility->phone??''); ?>" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="13" type = "tel" >
...
<?php /**PATH /home2/devcusto/public_html/laravel/opat/resources/views/facility/facility/form.blade.php ENDPATH**/ ?>