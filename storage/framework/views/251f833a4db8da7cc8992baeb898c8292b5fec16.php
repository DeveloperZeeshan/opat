                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 address_box">
                            <div class="pull-left">
                               <address>
                                   ...
                                   <p class="text-muted m-l-5"><?php echo e($rentpayment->getAddedByDetail->getCaretakerDetail->getCompanyDetail->getUserDetail->profile->address??''); ?></p>
                            ...
                            <div class="pull-right text-right">
                                <address>
                                    <h3>Caretaker,</h3>
                                    <b><p class="text-muted m-l-30"><?php echo e($rentpayment->getAddedByDetail->profile->address??"Not Available"); ?></p></b>
                                ...
                                <table class="table table-hover">
                                    ...
                                    <?php $__currentLoopData = $rentpayments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rentpayment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right"> <?php echo e($testdate); ?></td>
                        ...
                        <div class="col-md-12">
                            <div class="pull-right m-t-30 text-right">
                                ...
                                <hr>
                                <h3><b>Total :</b> $<?php echo e($total); ?></h3>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\OPAT_LIVE_FOR_CMS\resources\views/rentPayment/rent-payment/show.blade.php ENDPATH**/ ?>