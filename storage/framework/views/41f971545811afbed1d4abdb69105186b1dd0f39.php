            ...
            <div class="col-md-8 col-sm-12">
                <div class="white-box comment-widget">
                    ...
                    <ul class="media-list">
                        <li class="media">
                            ...
                            <div class="media-body">
                                ...
                                <div class="media reply">
                                    <div class="media-left">
                                        <a href="#"> <img alt="user" class="media-object" src="<?php echo e(asset(
                                            'plugins/images/users/hanna.jpg')); ?>"> </a>
                                    </div>
                                    <div class="media-body">
                        ...
                        <li class="media">
                            <div class="media-left">
                                <a href="#"> <img alt="user" class="media-object" src="<?php echo e(asset('plugins/images/users/jeffery.jpg')); ?>"> </a>
                            </div>
                            <div class="media-body">
                ...
                <div class="white-box">
                    <div class="profile-widget">
                        <div class="profile-img">
                            <img src="<?php echo e(asset('plugins/images/users/jeffery.jpg')); ?>" alt="user-img" class="img-circle">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\opatlive\opatlive\resources\views/dashboard/index2.blade.php ENDPATH**/ ?>