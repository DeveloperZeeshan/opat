            ...
            <div class="col-md-12">
                <div class="white-box">
                    ...
                    <form method="POST" action="<?php echo e(url('/consumer/consumer')); ?>" accept-charset="UTF-8"
                          class="form-horizontal" enctype="multipart/form-data" style="background: #12525c;color: #ffffff">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\opatlive\opatlive\resources\views/consumer/consumer/create.blade.php ENDPATH**/ ?>