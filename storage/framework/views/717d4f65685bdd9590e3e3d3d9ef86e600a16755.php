...
<div class="form-group <?php echo e($errors->has('memory_problem') ? 'has-error' : ''); ?>">
    ...
    <div class="col-md-6">
        <input class=""  style="margin-top: 9px" name="memory_problem_check" type="checkbox" id="memory_problem_check" <?php if(isset($cognitivepsycological) && $cognitivepsycological->memory_problem_check == 'on'): ?> checked <?php endif; ?>  class="daysCheckbox4">
...
<div class="form-group <?php echo e($errors->has('memory_care') ? 'has-error' : ''); ?>">
    <label for="memory_problem" class="col-md-4 control-label"><?php echo e('Memory Care'); ?></label>
    <div class="col-md-6">
        <input class=""  style="margin-top: 9px" name="memory_care_check" type="checkbox" id="memory_care_check" <?php if(isset($cognitivepsycological) && $cognitivepsycological->memory_care_check == 'on'): ?> checked <?php endif; ?> class="daysCheckbox4">
        <textarea class="form-control" rows="2" name="memory_care" type="textarea" id="memory_care" ><?php echo e($cognitivepsycological->memory_care??''); ?></textarea>
        <?php echo $errors->first('memory_care', '<p class="help-block">:message</p>'); ?>

    </div>
</div>


<div class="form-group <?php echo e($errors->has('Ambulatory') ? 'has-error' : ''); ?>">
    <label for="ambulatory" class="col-md-4 control-label"><?php echo e('Ambulatory'); ?></label>
    <div class="col-md-6">
        <input class=""  style="margin-top: 9px" name="ambulatory_check" type="checkbox" id="ambulatory_check" <?php if(isset($cognitivepsycological) && $cognitivepsycological->ambulatory_check == 'on'): ?> checked <?php endif; ?>  class="daysCheckbox4">
        <textarea class="form-control" rows="2" name="ambulatory" type="textarea" id="ambulatory" ><?php echo e($cognitivepsycological->ambulatory??''); ?></textarea>
        <?php echo $errors->first('Ambulatory', '<p class="help-block">:message</p>'); ?>
...
<?php /**PATH C:\wamp64\www\OPAT_LIVE_FOR_CMS\resources\views/cognitivePsycological/cognitive-psycological/form.blade.php ENDPATH**/ ?>