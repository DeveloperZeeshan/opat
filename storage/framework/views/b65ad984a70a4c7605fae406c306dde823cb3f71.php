   ...
   <div class="container">
      <div class="row">
         <div class="col-lg-6 col-md-6 mt-3">
            <div class="card">
               <img class="card-img-top" src="<?php echo e(asset('website')); ?>/images/News.png" alt="Card image cap">
               <div class="card-body">
                  <span class="card-link"><i class="far fa-calendar-alt"></i>June 24 - 26, 2020</span>
                  <span class="card-link"><i class="far fa-calendar-alt"></i>Lorem ipsum dolor sit</span>
...
<?php echo $__env->make('website.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/devcusto/public_html/laravel/opat/resources/views/website/news_and_events.blade.php ENDPATH**/ ?>