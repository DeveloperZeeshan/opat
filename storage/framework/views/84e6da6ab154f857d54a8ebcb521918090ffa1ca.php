...
<div class="form-group <?php echo e($errors->has('phone') ? 'has-error' : ''); ?>">
    ...
    <div class="col-md-6">
        <input class="form-control phone" name="phone" type="number" id="phone" value="<?php echo e($caretaker->getUserDetail->profile->phone??''); ?>" >
    ...
    <div class="col-md-6">
        <input class="form-control nationalIdCard" name="nation_id_card" type="number" id="nation_id_card" value="<?php echo e($caretaker->getUserDetail->profile->nation_id_card??''); ?>" required>
...
</div><?php /**PATH C:\wamp64\www\opatlive\opatlive\resources\views/caretaker/caretaker/form.blade.php ENDPATH**/ ?>