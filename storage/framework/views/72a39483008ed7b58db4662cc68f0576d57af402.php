                ...
                <div class="dropdown user-pro-body ">
                    <div class="profile-image">
                        ...
                        <ul class="dropdown-menu animated flipInY">
                            <li><a href="<?php echo e(url('account-settings')); ?>"><i class="fa fa-user"></i> Profile</a></li>
                ...
                <?php if(auth()->user()->isAdmin() == true): ?>
                    ...
                    <?php if(count(collect($section->items)) > 0): ?>
                        ...
                        <li class="two-column">
                            ...
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="<?php echo e(asset('page/page')); ?>">Pages</a></li>
                                <li><a href="<?php echo e(asset('ourSolution/our-solution')); ?>">Our Solutions</a></li>
                                <li><a href="<?php echo e(asset('affordableCare/affordable-care')); ?>">Affordable Care</a></li>
                                <li><a href="<?php echo e(asset('providesYourCare/provides-your-care')); ?>">Provides Your Care</a></li>
                                <li><a href="<?php echo e(asset('resource/resource')); ?>">Community Resource Section</a></li>
                                <li><a href="<?php echo e(asset('leadership/leadership')); ?>">Leadership</a></li>
                                <li><a href="<?php echo e(asset('newsAndEvent/news-and-event')); ?>">News and Events</a></li>
                                <li><a href="<?php echo e(asset('fAQ/f-a-q')); ?>">FAQ's</a></li>
                                <li><a href="<?php echo e(asset('learningManagement/learning-management')); ?>">Resource</a></li>
                        ...
                        <?php endif; ?>
                            <?php $__currentLoopData = $section->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <?php if( $menu->title  =='CognitivePsycological'): ?> <?php continue; ?> <?php endif; ?>
                                <?php if( $menu->title  =='SocialServiceEligibility'): ?> <?php continue; ?> <?php endif; ?>
                                <?php if( $menu->title  =='Page'): ?> <?php continue; ?> <?php endif; ?>
                                <?php if( $menu->title  =='OurSolution'): ?> <?php continue; ?> <?php endif; ?>
                                <?php if( $menu->title  =='AffordableCare'): ?> <?php continue; ?> <?php endif; ?>
                                <?php if( $menu->title  =='ProvidesYourCare'): ?> <?php continue; ?> <?php endif; ?>
                                <?php if( $menu->title  =='Resource'): ?> <?php continue; ?> <?php endif; ?>
                                <?php if( $menu->title  =='Leadership'): ?> <?php continue; ?> <?php endif; ?>
                                <?php if( $menu->title  =='NewsAndEvent'): ?> <?php continue; ?> <?php endif; ?>
                                <?php if( $menu->title  =='FAQ'): ?> <?php continue; ?> <?php endif; ?>
                                <?php if( $menu->title  =='LearningManagement'): ?> <?php continue; ?> <?php endif; ?>
                                <?php if(auth()->user()->hasrole('company')): ?>
                                        <?php if( $menu->title  =='Transport Tracker'): ?> <?php continue; ?> <?php endif; ?>
                                <?php endif; ?>
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php if(!auth()->user()->hasrole('user') ): ?>
                    <?php if(!auth()->user()->hasrole('guest')): ?>
                        <?php if(!auth()->user()->hasrole('finance')): ?>
                <li>
                    <a class="waves-effect" href="<?php echo e(url('calendar','all')); ?>">
...
</aside><?php /**PATH C:\wamp64\www\OPAT_LIVE_FOR_CMS\resources\views/layouts/partials/sidebar.blade.php ENDPATH**/ ?>