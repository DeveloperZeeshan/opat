                        ...
                        <table class="table" id="myTable">
                            ...
                            <?php $__currentLoopData = $company; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php echo e($item->getPackageDetail->name??"Not Available"); ?></td>
                                    <td><?php echo e($item->getUserDetail->name??"Not Available"); ?></td>
                                    <td><a href="<?php echo e(route('update_company_status',['company_id'=>$item->id,'user_id'=>$item->user_id,'status'=>$item->status])); ?>" onclick="return confirm('Are you sure?')"><?php echo $item->status_detail??"Not Available"; ?></a></td>
                                    <td>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/devcusto/public_html/laravel/opat/resources/views/company/company/index.blade.php ENDPATH**/ ?>