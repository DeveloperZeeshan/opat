<?php $__env->startPush('css'); ?>
    <link href="<?php echo e(asset('plugins/components/switchery/dist/switchery.min.css')); ?>" rel="stylesheet"/>
<?php $__env->stopPush(); ?>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    ...
                    <a class="btn btn-success pull-right" href="<?php echo e(url('role-management')); ?>"><i class="icon-eye"></i> &nbsp; View Roles</a>
                    <div class="clearfix"></div>
                    <hr>
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2">
                            <form class="form-horizontal" method="post" action="<?php echo e(url('role/edit/'.$role->id)); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text"
                                               ...
                                               name="name" value="<?php echo e($role->name); ?>"  autofocus>
                                        ...
                                        <?php $__currentLoopData = $section->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <input <?php if(in_array($permissions['view'],$role_permissions)): ?> checked <?php endif; ?> type="checkbox" class="view" name="permissions[]"
                                                           value="<?php echo e($permissions['view']); ?>">
                                                </td>
                                                <td class="text-center">
                                                    <input <?php if(in_array($permissions['add'],$role_permissions)): ?> checked <?php endif; ?> type="checkbox" class="add" name="permissions[]"
                                                           value="<?php echo e($permissions['add']); ?>">
                                                </td>
                                                <td class="text-center">
                                                    <input <?php if(in_array($permissions['edit'],$role_permissions)): ?> checked <?php endif; ?> type="checkbox" class="edit" name="permissions[]"
                                                           value="<?php echo e($permissions['edit']); ?>">
                                                </td>
                                                <td class="text-center">
                                                    <input <?php if(in_array($permissions['delete'],$role_permissions)): ?> checked <?php endif; ?> type="checkbox" class="delete" name="permissions[]"
...
<?php $__env->startPush('js'); ?>
    <script src="<?php echo e(asset('plugins/components/switchery/dist/switchery.min.js')); ?>"></script>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/devcusto/public_html/laravel/opat/resources/views/role/edit.blade.php ENDPATH**/ ?>