            ...
            <tbody>
                <?php $__currentLoopData = $data['rentPayment']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr style=" background: #eee;">
                        ...
                        <td style=" padding: 10px; color: black; text-align: right; font-size: 20px;"><?php echo e($item['name']??''); ?></td>
...
</html><?php /**PATH C:\wamp64\www\opatlive\opatlive\resources\views/website/rentpayment_email_send.blade.php ENDPATH**/ ?>