               ...
               <div class="card">
                  ...
                  <div class="card-header" role="tab" id="headingOne1">
                     <a data-toggle="collapse" data-parent="#accordionEx" href="#collapseOne1" aria-expanded="true"
                        ...
                        <h5 class="mb-0">
                           Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do<i class="fas fa-angle-down rotate-icon"></i>
                        </h5>
                     </a>
                  </div>
                  <!-- Card body -->
            ...
            <form class="hero-form-1">
               <div class="form-group">
                  <div class="input-group">
                     ...
                     <input   type="text" class="form-control" id="text" aria-describedby="emailHelp" placeholder="Your Full Name*" />
                  </div>
               </div>
               <div class="form-group">
                  <div class="input-group">
...
<?php echo $__env->make('website.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\opatlive\opatlive\resources\views/website/faq.blade.php ENDPATH**/ ?>