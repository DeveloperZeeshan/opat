...
<div class="form-group <?php echo e($errors->has('phone') ? 'has-error' : ''); ?>">
    ...
    <div class="col-md-6">
        <input class="form-control" name="phone" id="phone" value="<?php echo e($finance->phone??''); ?>" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="13" type = "tel">
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home2/devcusto/public_html/laravel/opat/resources/views/finance/finance/form.blade.php ENDPATH**/ ?>