   ...
   <div class="container banner-content">
      <div class="row">
         <div class="col-md-12 hero-quote Login">
            ...
            <a href="<?php echo e(route('guest_signin_process')); ?>" type="button" class="btn btn-info" style="background: #12525c;width: 100%;margin-top: 10px;border-radius: 10px"><i class="fas fa-location-arrow"></i> Login as Guest</a>               
         </div>
      </div>
   </div>
</section>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('website.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/devcusto/public_html/laravel/opat/resources/views/website/login.blade.php ENDPATH**/ ?>