...
<script>
    ...
    $(document).on('click','.transport_tracker_id',function(e){
        ...
        $.ajax({
            ...
            success: function(response) {
                location.href = "<?php echo e(url('transportTracker/transport-tracker/')); ?>";
            }
        });
    });
    ...
    $(document).on('click','.cognitive_id',function(e){
        ...
        $.ajax({
            ...
            type:'get',
            success: function(response) {
                location.href = "<?php echo e(url('cognitivePsycological/cognitive-psycological/')); ?>";
            }
        });
    });
    ...
    $(document).on('click','.service_id',function(e){
        ...
        $.ajax({
            ...
            type:'get',
            success: function(response) {
                location.href = "<?php echo e(url('socialServiceEligibility/social-service-eligibility/')); ?>";
            }
        });
    });
</script>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\OPAT_LIVE_FOR_CMS\resources\views/consumer/consumer/show.blade.php ENDPATH**/ ?>