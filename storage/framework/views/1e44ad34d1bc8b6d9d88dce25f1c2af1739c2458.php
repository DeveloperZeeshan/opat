                        ...
                        <table class="table" id="myTable">
                            ...
                            <?php $__currentLoopData = $medication; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php echo e(\Carbon\Carbon::parse($item->created_at??"Not Available")->toFormattedDateString()); ?></td>
                                    <td><?php echo e($item->medication??"Not Available"); ?></td>
                                    <td><?php echo e($item->frequency_taken??"Not Available"); ?></td>
                                    <td>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/devcusto/public_html/laravel/opat/resources/views/medication/medication/index.blade.php ENDPATH**/ ?>