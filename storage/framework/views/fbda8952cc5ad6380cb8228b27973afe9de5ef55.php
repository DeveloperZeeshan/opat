            ...
            <div class="col-sm-12">
                <div class="white-box">
                    <h3 class="box-title pull-left">Learning Management <?php echo e($learningmanagement->id); ?></h3>
                        ...
                        <a class="btn btn-success pull-right" href="<?php echo e(route('quick_links')); ?>">
...
<?php echo $__env->make('website.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\opatlive\opatlive\resources\views/website/learning.blade.php ENDPATH**/ ?>