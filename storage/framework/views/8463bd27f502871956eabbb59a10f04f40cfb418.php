...
</div><div class="form-group <?php echo e($errors->has('nature_of_incident') ? 'has-error' : ''); ?>">
    <label for="nature_of_incident" class="col-md-4 control-label"><?php echo e('Nature Of Incident'); ?></label>
    <div class="col-md-6">
        <input class="form-control" name="nature_of_incident" type="text" id="nature_of_incident" value="<?php echo e($incidentreport->nature_of_incident??''); ?>" >
        <?php echo $errors->first('nature_of_incident', '<p class="help-block">:message</p>'); ?>

    </div>
</div><div class="form-group <?php echo e($errors->has('incident_detail') ? 'has-error' : ''); ?>">
...
</div><div class="form-group <?php echo e($errors->has('report_created_by') ? 'has-error' : ''); ?>">
...
<?php /**PATH C:\wamp64\www\opatlive\opatlive\resources\views/incidentReport/incident-report/form.blade.php ENDPATH**/ ?>