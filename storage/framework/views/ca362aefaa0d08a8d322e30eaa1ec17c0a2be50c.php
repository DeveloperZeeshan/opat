<?php $__env->startPush('css'); ?>
    <link href="<?php echo e(asset('plugins/components/css-chart/css-chart.css')); ?>" rel="stylesheet">
            ...
            <div class="col-md-4 col-sm-6">
                <div class="white-box album-widget">
                    ...
                    <div class="alb-photos m-t-30">
                        <div class="alb-item">
                            <img src="<?php echo e(asset('plugins/images/a1.jpg')); ?>" alt="item">
                        </div>
                        <div class="alb-item">
                            <img src="<?php echo e(asset('plugins/images/a2.jpg')); ?>" alt="item">
                        </div>
                        <div class="alb-item">
                            <img src="<?php echo e(asset('plugins/images/a3.jpg')); ?>" alt="item">
                        </div>
...
<?php $__env->startPush('js'); ?>
    <script src="<?php echo e(asset('js/db3.js')); ?>"></script>

<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\opatlive\opatlive\resources\views/dashboard/index3.blade.php ENDPATH**/ ?>