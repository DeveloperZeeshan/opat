         ...
         <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
              ...
              <!--  <li class="nav-item <?php echo e(Request::is('quick_links') ? 'active' : ''); ?>">
               ...
               <li class="nav-item <?php echo e(Request::is('resource') ? 'active' : ''); ?>">
                  <a class="nav-link" href="<?php echo e(url('resource')); ?>">Resource</a>
               </li>
               <?php if(Auth::check()): ?>
...
<?php $__env->stopPush(); ?><?php /**PATH C:\wamp64\www\OPAT_LIVE_FOR_CMS\resources\views/website/layout/menu.blade.php ENDPATH**/ ?>