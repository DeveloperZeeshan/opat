                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="pull-left m-t-30 text-right">
                                ...
                                <h3 align="center"><label>Signature :</label><input value="" class="form-control" id="sign"></h3>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/devcusto/public_html/laravel/opat/resources/views/rentPayment/rent-payment/show.blade.php ENDPATH**/ ?>