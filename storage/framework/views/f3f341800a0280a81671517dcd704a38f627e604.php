<div class="form-group <?php echo e($errors->has('title') ? 'has-error' : ''); ?>">
    ...
    <div class="col-md-6">
        <input class="form-control" name="title" type="text" id="title" value="<?php echo e($resource->title??''); ?>" >
    ...
    <div class="col-md-6">
        <textarea class="form-control" rows="5" name="description" type="textarea" id="description" ><?php echo e($resource->description??''); ?></textarea>
    ...
    <div class="col-md-6">
        <input class="form-control" name="image" type="file" id="image" value="<?php echo e($resource->image??''); ?>" onchange="PreviewImage_1();">
        <?php echo $errors->first('image', '<p class="help-block">:message</p>'); ?>

        <img src="<?php echo e(asset('website')); ?>/<?php echo e($resource->image??''); ?>" id="imagePreview_1" width="100" height="100">
    </div>
</div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\wamp64\www\OPAT_LIVE_FOR_CMS\resources\views/resource/resource/form.blade.php ENDPATH**/ ?>