                ...
                <div class="row">
                    ...
                    <div class="col-md-5">
                        <div class="education_documents">
                            ...
                            <h1>Education Level:</h1><p><?php echo e($consumer->getEducationalLevelDetail->name??''); ?> </p>
                        </div>
                ...
                <div class="white-box">
                    ...
                    <div class="table-responsive">
                        ...
                        <div class="col-md-3">
                            <div class="consumer_card_content">
                                <div class="consumer_image">
                                    <img src="<?php echo e(asset('website/images/5.jfif')); ?>" alt="" class="img-fluid">
                                    
                                </div>
                                <div class="consumer_content">
                                    <h2></h2>
                                    <span class="facility_name">Mobility, transport, escort</span>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\opatlive\opatlive\resources\views/consumer/consumer/show.blade.php ENDPATH**/ ?>