            ...
            <form class="hero-form-1" id="sign_up_form" method="post" action="<?php echo e(url('signup_process')); ?>" enctype="multipart/form-data">
              ...
              <?php else: ?>
               ...
               <button type="submit" class="btn btn-primary" id="submit_btn"><i class="fas fa-location-arrow"></i>Sign Up</button>
                <br>
                <?php if($package != null): ?>
                  <?php if($package->is_custom_package != 1 && $package->price != 0): ?>              
                    <script
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('website.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\opatlive\opatlive\resources\views/website/sign_up.blade.php ENDPATH**/ ?>