...
<div class="Form_p2" >
 ...
 <input class="" style="margin-top: 9px" name="extension_granted" type="checkbox" id="extension_granted" value="1" <?php if(isset($consumer)  && $consumer->getUserDetail->profile->extension_granted == 1): ?> checked <?php endif; ?>>
 <?php else: ?>
 <input class="" style="margin-top: 9px" name="extension_granted" type="checkbox" id="extension_granted" value="">
 <?php endif; ?>
...
<?php $__env->stopPush(); ?><?php /**PATH /home2/devcusto/public_html/laravel/opat/resources/views/consumer/consumer/form.blade.php ENDPATH**/ ?>