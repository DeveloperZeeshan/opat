<div class="form-group <?php echo e($errors->has('image') ? 'has-error' : ''); ?>">
    ...
    <div class="col-md-6">
        <input class="form-control" name="image" type="file" id="image" value="<?php echo e($affordablecare->image??''); ?>" onchange="PreviewImage_1();">
         <img src="<?php echo e(asset('website')); ?>/<?php echo e($affordablecare->image??''); ?>" id="imagePreview_1" width="100" height="100">
    ...
    <div class="col-md-6">
        <input class="form-control" name="title" type="text" id="title" value="<?php echo e($affordablecare->title??''); ?>" >
    ...
    <div class="col-md-6">
        <textarea class="form-control" rows="5" name="description" type="textarea" id="description" ><?php echo e($affordablecare->description??''); ?></textarea>
...
<?php $__env->stopPush(); ?><?php /**PATH C:\wamp64\www\OPAT_LIVE_FOR_CMS\resources\views/affordableCare/affordable-care/form.blade.php ENDPATH**/ ?>