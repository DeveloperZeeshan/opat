                ...
                <div class="white-box">
                    ...
                    <div class="table-responsive">
                        <table class="table" id="myTable">
                            ...
                            <tbody>
                            <?php $__currentLoopData = $learningmanagement; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><?php echo e($loop->iteration??$item->id); ?></td>
                                    <td><?php echo e($item->lecture); ?></td>
                                    <!-- <td><?php echo e($item->upload_file); ?></td> -->
                                    <td><video width="220" height="100" controls>
                              <source src="<?php echo e(asset('website/'.$item->upload_video)); ?>" type="video/mp4" >
                            </video></td>
                                    <td>  

                                            <a title="Create Quiz" style="cursor: pointer;" class="create_lms_id" attr="<?php echo e($item->id); ?>" href="<?php echo e(route('learning')); ?>">  
    ...
    <section class="sec-business-analysis mt-5">
        <div class="container">
            <div class="row" >
                ...
                <div class="col-md-7">
                  <form method="POST" action="<?php echo e(route('quiz_submit')); ?>" accept-charset="UTF-8" class="form-horizontal" >
                ...
                <br>
                  <h1 style="border-bottom: 2px solid white;">Attempt Quiz</h1>
                        ...
                        <?php $__currentLoopData = $assessment; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$element): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                       <p style="color: white;"> Question#<?php echo e($element->id); ?></p>
                        <?php if($element->question_type == 'mcqs'): ?>
                        <!-- <input type="hidden" name="question_id" value="<?php echo e($element->id); ?>"> -->
                        <div class="mcqs">
                          <h1><?php echo e($element->question); ?></h1>
                          <div class="form-check">

                             <input class="form-check-input" type="hidden"name="answer[<?php echo e($key); ?>][question]" value="<?php echo e($element->id); ?>" id="true">
                             <input class="form-check-input" type="radio"name="answer[<?php echo e($key); ?>][ans]" value="<?php echo e(json_decode($element->option)[0]); ?>" id="true">
                             <label class="form-check-label" for="Option1"><?php echo e(json_decode($element->option)[0]); ?> </label>
                          </div>
                          <div class="form-check">
                              <input class="form-check-input" type="radio"name="answer[<?php echo e($key); ?>][ans]" value="<?php echo e(json_decode($element->option)[1]); ?>" id="false" checked="">
                             <label class="form-check-label" for="Option2"><?php echo e(json_decode($element->option)[1]); ?> </label>
                          </div>
                             <div class="form-check">
                             <input class="form-check-input" type="radio" name="answer[<?php echo e($key); ?>][ans]" value="<?php echo e(json_decode($element->option)[2]); ?>" id="Option3" >
                             <label class="form-check-label" for="Option3"><?php echo e(json_decode($element->option)[2]); ?></label>
                          </div>
                          <div class="form-check">
                             <input class="form-check-input" type="radio" name="answer[<?php echo e($key); ?>][ans]" value="<?php echo e(json_decode($element->option)[3]); ?>" id="Option4" >
                             <label class="form-check-label" for="Option4"><?php echo e(json_decode($element->option)[3]); ?></label>
                          </div>
                       </div>
                          <?php elseif($element->question_type == 'true_false'): ?>   
                      ...
                      <?php elseif($element->question_type == 'free_text'): ?>
                       <div class="text_box">
                          <h1><?php echo e($element->question); ?></h1>
                          <div class="form-check">
                            <input class="form-check-input" type="hidden"name="answer[<?php echo e($key); ?>][question]" value="<?php echo e($element->id); ?>" id="true">
                             <textarea id="text_box" name="answer[<?php echo e($key); ?>][ans]" class="md-textarea form-control" rows="4" cols="50" ></textarea>
                          </div>
                       </div>
                   <?php endif; ?>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('website.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\opatlive\opatlive\resources\views/website/quick-links.blade.php ENDPATH**/ ?>