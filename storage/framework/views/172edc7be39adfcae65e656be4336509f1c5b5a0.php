...
<div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-6">
                        <div class="white-box text-center">
                            <img src="<?php echo e(asset('plugins/images/chair.jpg')); ?>" id="product-image" class="img-responsive" />
                        </div>
                        <div class="pro-photos">
                            <div class="photos-item item-active">
                                <img src="<?php echo e(asset('plugins/images/chair.jpg')); ?>">
                            </div>
                            <div class="photos-item">
                                <img src="<?php echo e(asset('plugins/images/chair2.jpg')); ?>">
                            </div>
                            <div class="photos-item">
                                <img src="<?php echo e(asset('plugins/images/chair3.jpg')); ?>">
                            </div>
                            <div class="photos-item">
                                <img src="<?php echo e(asset('plugins/images/chair4.jpg')); ?>">
                            </div>
                            <div class="photos-item">
                                <img src="<?php echo e(asset('plugins/images/chair2.jpg')); ?>">
                            </div>
    ...
    <div class="row">
        <div class="col-md-4 col-sm-6 col-xs-12">
            <div class="white-box">
                <div class="product-img">
                    <img src="<?php echo e(asset('plugins/images/chair.jpg')); ?>" class="img-responsive" />
                </div>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
            <div class="white-box">
                <div class="product-img">
                    <img src="<?php echo e(asset('plugins/images/chair2.jpg')); ?>" class="img-responsive" />
                </div>
                <div class="product-text">
                    <h3 class="box-title m-b-0">Rounded Chair</h3>
                    <small class="text-muted db">globe type chair for rest</small>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
            <div class="white-box">
                <div class="product-img">
                    <img src="<?php echo e(asset('plugins/images/chair4.jpg')); ?>" class="img-responsive" />
                </div>
                <div class="product-text">
                    <h3 class="box-title m-b-0">Rounded Chair</h3>
                    <small class="text-muted db">globe type chair for rest</small>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\opatlive\opatlive\resources\views/ecommerce/product-detail.blade.php ENDPATH**/ ?>