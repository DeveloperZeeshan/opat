...
<?php if(auth()->user()->HasRole('admin') || auth()->user()->HasRole('user') || auth()->user()->HasRole('career')): ?>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('add-'.str_slug('Quiz'))): ?>
                        <a class="btn btn-success pull-right" href="<?php echo e(url('/quiz/quiz/create')); ?>"><i
                    ...
                    <div class="table-responsive">
                            ...
                            <?php $__currentLoopData = $quiz; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit-'.str_slug('Quiz'))): ?>
                                            <a href="<?php echo e(url('/quiz/quiz/' . $item->id . '/edit')); ?>"
                                               title="Edit Quiz">
                                        ...
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete-'.str_slug('Quiz'))): ?>
                                            <form method="POST"
                                                  action="<?php echo e(url('/quiz/quiz' . '/' . $item->id)); ?>"
                        ...
                        <div class="pagination-wrapper"> <?php echo $quiz->appends(['search' => Request::get('search')])->render(); ?> </div>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/devcusto/public_html/laravel/opat/resources/views/quiz/quiz/index.blade.php ENDPATH**/ ?>