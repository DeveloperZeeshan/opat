   ...
   <div class="container">
      <div class="row">
         ...
         <div class="col-md-4 subscribes" >
            <h2>Subscribe</h2>
            <form class="footer-form pt-3 form" id="newsLetter" method="post" action="<?php echo e(url('news_letter')); ?>">
              <?php echo csrf_field(); ?>
      ...
      $("#newsLetter").keyup(function (e) {
            ...
            if (email == "") {
                 ...
                 console.log('ajax');
                  ...
                  $.ajax({
                     type: 'POST',
                     url: "<?php echo e(route('news_letter')); ?>",
                     data: {
                        email: email,
                        _token: _token
                     },
...
<?php /**PATH /home2/devcusto/public_html/laravel/opat/resources/views/website/layout/master.blade.php ENDPATH**/ ?>