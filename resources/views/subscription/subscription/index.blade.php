                ...
                <div class="white-box">
                    ...
                    <div class="table-responsive">
                        <table class="table" id="myTable">
                            ...
                            <tr>
                                <th>#</th>
                                <th>RoleId</th><th>Subscription Type Id</th><th>Name</th>
                                <th>Actions</th>
                            </tr>
                            </thead>
                            <tbody>
                            @foreach($subscription as $item)
                                <tr>
                                    ...
                                    <td>{{ $item->roleId }}</td><td>{{ $item->subscription_type_id }}</td><td>{{ $item->name }}</td>
                                    <td>
                                        ...
                                        @can('delete-'.str_slug('Subscription'))
                                            <form method="POST"
                                                  action="{{ url('/subscription/subscription' . '/' . $item->id) }}"
