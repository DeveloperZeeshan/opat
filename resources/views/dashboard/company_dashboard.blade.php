                                ...
                                <div class="white-box small-box-widget">
                                        <div class="p-t-10 p-b-10">
                                            ...
                                            <div class="detail-box">
                                                <h4>Caretakers <span class="pull-right text-warning font-22 font-normal">{{$caretakerCount??0}}%</span>
                                                </h4>
                                                <div class="progress">
                                                    <div class="progress-bar progress-bar-warning" role="progressbar"
                                                         aria-valuenow="{{$caretakerCount??0}}" aria-valuemin="0" aria-valuemax="100"
                                                         style="width: {{$caretakerCount??0}}%">
                                                        <span class="sr-only">{{$caretakerCount??0}}% Complete</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <a href="{{ url('/consumer/consumer') }}">
                                <div class="white-box small-box-widget">
                                    <div class="p-t-10 p-b-10">
                                        ...
                                        <div class="detail-box">
                                            <h4>Residents<span class="pull-right text-danger font-22 font-normal">{{$consumerCount??0}}%</span>
                                            </h4>
                                            <div class="progress">
                                                <div class="progress-bar progress-bar-danger" role="progressbar"
                                                     aria-valuenow="{{$consumerCount??0}}" aria-valuemin="0" aria-valuemax="100"
                                                     style="width: {{$consumerCount??0}}%">
                                                    <span class="sr-only">{{$consumerCount??0}}% Complete</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="circle-chart">
                            <div class="c1">
                                <input class="knob" data-min="0" data-max="100" data-bgColor="#e4edef"
                                       ...
                                       data-thickness=".05" data-linecap=round value="{{$managersCount??0}}" readonly>
                            </div>
                            <div class="c2">
                                <input class="knob" data-min="0" data-max="100" data-bgColor="#e4edef"
                                       data-fgColor="#d9cbb1" data-displayInput=false data-width="154" data-height="154"
                                       data-thickness=".05" data-linecap=round value="{{$caretakerCount??0}}" readonly>
                            </div>
                            <div class="c3">
                                <input class="knob" data-min="0" data-max="100" data-bgColor="#e4edef"
                                       data-fgColor="#8D8F8E" data-displayInput=false data-width="125" data-height="125"
                                       data-thickness=".05" data-linecap=round value="{{$consumerCount??0}}" readonly>
                            </div>
                            <div class="chart-overlap"><i class="icon-user"></i></div>
                        </div>
                        <ul class="list-inline m-b-0 m-t-30 t-a-c">
                            <li>
                                <h6 class="font-15" style="color: #0F4C82;"><i class="fa fa-circle m-r-5"></i>{{$managersCount??0}}%</h6>
                            </li>
                            <li>
                                <h6 class="font-15"  style="color: #d9cbb1;"><i class="fa fa-circle m-r-5"></i>{{$caretakerCount??0}}%</h6>
                            </li>
                            <li>
                                <h6 class="font-15"  style="color: #8D8F8E;"><i class="fa fa-circle m-r-5"></i>{{$consumerCount??0}}%</h6>
                            </li>
                        </ul>
                    </div>
                </div>
