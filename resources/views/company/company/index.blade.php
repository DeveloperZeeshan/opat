                        ...
                        <table class="table" id="myTable">
                            ...
                            @foreach($company as $item)
                                <tr>
                                    ...
                                    <td>{{ $item->getPackageDetail->name??"Not Available" }}</td>
                                    <td>{{ $item->getUserDetail->name??"Not Available" }}</td>
                                    <td><a href="{{route('update_company_status',['company_id'=>$item->id,'user_id'=>$item->user_id,'status'=>$item->status])}}" onclick="return confirm('Are you sure?')">{!! $item->status_detail??"Not Available" !!}</a></td>
                                    <td>
